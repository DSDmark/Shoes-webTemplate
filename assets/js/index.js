...
change_theme.addEventListener('click', () => {
  ...
  if (isDark) {
    change_theme.innerHTML = '<li class="nav_item" id="change_theme"><i class="themeIcon fas fa-moon"></i></li>';
  } else {
    change_theme.innerHTML = '<li class="nav_item" id="change_theme"><i class="themeIcon fas fa-sun"></i></li>';
  }
  isDark = !isDark
